...
const About: React.FC = () => {
  return (
    <section id="about" className="w-full py-24 md:py-32 px-4 md:px-12 lg:px-24 bg-paper-200 dark:bg-charcoal-900 relative border-t border-black/5 dark:border-white/5 transition-colors duration-500 overflow-hidden">
          ...
          <div className="sticky top-24 md:top-32 w-full flex flex-col justify-start">
             ...
             >
                ...
                <motion.div 
                  ...
                  className="h-1 w-20 md:w-24 bg-charcoal-900 dark:bg-white mt-6 md:mt-8 origin-left" 
                />
                ...
                <motion.p 
                    ...
                    className="mt-6 md:mt-8 text-xs font-mono text-neutral-500 max-w-xs"
                >
