...
const Hero: React.FC = () => {
  ...
  return (
    <section 
      ...
      className="relative min-h-[90vh] md:min-h-screen w-full flex flex-col justify-center items-center px-4 md:px-12 lg:px-24 overflow-hidden pt-24 md:pt-0 text-center selection:bg-charcoal-900 selection:text-white dark:selection:bg-white dark:selection:text-charcoal-900"
    >
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <div className="flex flex-col items-center justify-center mb-8 md:mb-16 pointer-events-none select-none w-full max-w-[95vw]">
           <h1 className="font-display font-extrabold text-[clamp(4rem,18vw,14rem)] md:text-[12vw] tracking-[-0.05em] text-charcoal-900 dark:text-white leading-[0.8] z-10">
              VISHAL
           </h1>
           <div className="flex items-center gap-2 md:gap-8 w-full px-2">
              ...
              >
                 <span className="dark:hidden">RATHOD</span>
                 <span className="hidden dark:inline" style={{ WebkitTextStroke: '1px rgba(255,255,255,0.3)' }}>RATHOD</span>
              </h1>
              <div className="flex-grow h-[1px] bg-charcoal-900/10 dark:bg-white/10 hidden sm:block" />
           </div>
        </div>
