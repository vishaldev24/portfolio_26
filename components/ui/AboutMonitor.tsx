...
const FloatingChip = ({ children, icon: Icon, color, delay }: any) => (
  <motion.div
    ...
    className={`flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 dark:bg-charcoal-800/40 backdrop-blur-md border border-white/20 dark:border-white/5 shadow-lg group hover:bg-white/20 dark:hover:bg-charcoal-700/60 transition-colors`}
  >
...
const AboutMonitor: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="relative w-full py-10 md:py-20 perspective-2000">
