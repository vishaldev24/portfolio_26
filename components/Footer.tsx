...
const Footer: React.FC = () => {
  ...
  return (
    <footer id="contact" className="w-full min-h-screen bg-paper-200 dark:bg-charcoal-900 flex flex-col justify-between px-6 md:px-12 lg:px-24 py-24 relative transition-colors duration-500">
      ...
      <div className="relative z-10 flex-grow w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div className="flex flex-col items-start">
          <motion.span 
            ...
            viewport={{ once: true }}
            className="relative text-neutral-500 font-mono mb-6 block"
          >
            Have an idea?
          </motion.span>
          ...
          <div className="overflow-hidden mb-8">
            <motion.h2 
              ...
              className="relative font-serif font-bold text-7xl md:text-8xl lg:text-9xl leading-[0.9] tracking-tighter text-charcoal-900 dark:text-white"
            >
              Let's
            </motion.h2>
            <motion.h2 
          ...
          <motion.p 
            ...
            className="relative text-xl text-neutral-600 dark:text-neutral-400 max-w-md leading-relaxed"
          >
